<nav class="navbar navbar-expand navbar-light mx-auto" style="max-width:1200px;">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav ms-auto p-0 gap-2 my-2">
            ...
            @else
                <li class="nav-item"><a class="btn btn-primary" href="{{ route('user_auth.register_form') }}"
                >会員登録</a></li>
                <li class="nav-item"><a class="btn btn-success" style="text-decoration:none;" href="{{ route('user_auth.login_form') }}"
                >ログイン</a></li>
            @endif
        </ul>
    </div>
